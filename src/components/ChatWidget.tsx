...
const ChatWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-5 font-sans">
      
      {/* --- CHAT OYNASI --- */}
      <div
        className={`
          w-[360px] sm:w-[400px] h-[550px] max-h-[75vh]
          /* Glassmorphism fon - Dark Mode uchun */
      ...
      >
        {/* Header */}
        <div className="relative overflow-hidden bg-emerald-950/40 border-b border-emerald-500/20 p-4 flex items-center justify-between">
          {/* Orqa fon uchun yengil glow effekt */}
          ...
          <button 
            ...
            className="p-2 hover:bg-white/10 rounded-full transition-colors text-emerald-100/70 hover:text-white"
          >
            <X size={20} />
          </button>
        </div>
          ...
          {messages.map((msg: Message) => (
            <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
              <div
                ...
                `}
              >
                {/* Bot xabarida kichik iconcha qo'shish */}
                {msg.sender === 'bot' && (
        ...
        {/* Input Footer */}
        <div className="p-4 bg-slate-900/50 border-t border-emerald-500/20 backdrop-blur-md">
          <div className="flex items-center gap-2 bg-slate-950/50 rounded-full px-4 py-2 border border-emerald-500/20 focus-within:border-emerald-500/60 focus-within:shadow-[0_0_15px_rgba(16,185,129,0.1)] transition-all">
            ...
            <button
              ...
              className={`
                ...
                ${inputValue.trim() 
                  ? 'bg-emerald-500 text-white shadow-[0_0_10px_rgba(16,185,129,0.4)] hover:scale-110 hover:bg-emerald-400' 
      ...
      {/* --- LAUNCHER TUGMASI (AI ROBOT ICON) --- */}
      <button
      ...
      >
        ...
        {isOpen ? (
          ...
          <>
            ...
            {/* Kichik yiltiroq effekt icon tepasida */}
